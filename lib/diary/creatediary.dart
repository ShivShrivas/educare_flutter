...
class CreateDiaryState extends State<CreateDiary> {
  ...
  List<String> _statusRevert = ["No", "Yes"];
  List<String> _noticeFor = ["All","Class Wise", "Individual"];
  List<String> _noticeForStaff = ["Both","Teaching", "Non Teaching"];
  String _statusRevertValue = "No";
  String _statusGroupValue = "All",groupType="1";
  String _noticeForGroupValue = "All",noticeForType="1";
  ...
  Future<void> saveDiaryData(BuildContext context,int relationshipId,int sessionID,int fyID,int userID) async {
    final api = Provider.of<ApiService>(context, listen: false);
    SharedPreferences preferences = await SharedPreferences.getInstance();
    return await api.createDialry("1","0",noticeForType,classCode,"0",_statusRevertValue,headlineController.text,descriptionController.text,relationshipId,sessionID,fyID,userID)
        .then((result) {
    //  Navigator.of(_keyLoader.currentContext,rootNavigator: true).pop();
      if(result[0].status == "1"){
        headlineController.text="";
        descriptionController.text="";
        var tranIDforfileUpload=result[0].id;
        if(_filePath.isNotEmpty){
          uploadfile(tranIDforfileUpload,relationshipId,sessionID);
        }else{
          Navigator.of(context,rootNavigator: true).pop();
          commonAlert.messageAlertSuccess(context,"Diary saved successfully","Successfully");
        }
      }else{
        commonAlert.messageAlertError(context,"Diary not uploaded","Error");
      }
    }).catchError((error) {
      Navigator.of(context,rootNavigator: true).pop();
      commonAlert.messageAlertError(context,"Diary not uploaded","Error");
  ...
  Future uploadfile(String tranId,int relationshipID,int sessionid) async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(colors.imageUploadUrl+'DigitalDiaryApi/InsertUpdateDeleteDigitalDiaryFiles'));
    ...
    print("--NEW_PATHHTTP--- "+_filePath);
    print("--tranId--- "+tranId +"relationshipId--"+relationshipId+"sessionID=="+sessionID);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Create Diary".toUpperCase(),textAlign: TextAlign.center,style: new TextStyle(color: Colors.white,fontSize: 16.0,fontFamily: 'Montserrat',
                                  ...
                                  //color: Colors.redAccent,
                                    child: Column(
                                        ...
                                        children: <Widget>[
                                                          ...
                                                          Row(
                                                            children: [
                                                              Padding(padding:  new EdgeInsets.all(5.0),
                                                                child: Text("Message For Students",textAlign: TextAlign.left,
                                                                    ...
                                                                    child: RadioGroup<String>.builder(
                                                                      ...
                                                                      onChanged: (value) => setState(() {
                                                                        ...
                                                                        if(_noticeForGroupValue =="Class Wise"){
                                                                          noticeForType="2";
                                                                        }else if(_noticeForGroupValue =="Individual"){
                                                                          noticeForType="3";
                                                                        }
                                                                      }),
                                                                      items: _noticeFor,
                                          ...
                                          ////////////////////////// Search List  ///////////////////////////////////////////
                                          Visibility(
                                              visible: _noticeForGroupValue == 'Individual' ? true : false,
                                              child: Container(
                                                  child: Padding(padding:  new EdgeInsets.all(5.0),
                                                    child: Column(
                                                      //mainAxisAlignment: MainAxisAlignment.center,
                                                    ...
                                                    //mainAxisAlignment: MainAxisAlignment.center,
                                                      children:<Widget>[
                                                        Row(
                                                          children: [
                                                            Padding(padding:  new EdgeInsets.all(5.0),
                                                              child: Text("Want to revert message",textAlign: TextAlign.left,
                                                                  style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                      fontWeight: FontWeight.w700)),
                                                            ),
                                                          ],
                                                          ...
                                                          children: <Widget>[
                                                            Expanded(
                                                                child:Container(
                                                                  child: RadioGroup<String>.builder(
                                                                    direction: Axis.horizontal,
                                                                    groupValue: _statusRevertValue,
                                                                    onChanged: (value) => setState(() {
                                                                      _statusRevertValue = value!;
                                                                     /* if(_statusRevertValue =="No"){
                                                                        _statusRevertValue="No";
                                                                      }else{
                                                                        _statusRevertValue="Yes";
                                                                      }*/
                                                                    }),
                                                                    items: _statusRevert,
                                                                    itemBuilder: (item) => RadioButtonBuilder(
                                                            ...
                                                            child: MaterialButton(
                                                              ...
                                                              onPressed: () async {
                                                               if(headlineController.text.isEmpty){
                                                                  commonAlert.showToast(context,"Enter title");
                                                               }else if(descriptionController.text.isEmpty){
                                                                  commonAlert.showToast(context,"Enter message");
                                                               }else{
                                                                 ...
                                                                 setState(() {
                                                                   ...
                                                                   print("API DATA");
                                                                   saveDiaryData(context,relationshipID,sessionid,fyid,userid);
                                                                 });
