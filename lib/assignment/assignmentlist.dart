import 'package:educareadmin/assignment/createassignment.dart';
import 'package:educareadmin/conts/colors.dart';
import 'package:educareadmin/createnotices/noticedetails.dart';
...
class AssignmentListState extends State<AssignmentList> {
  ...
  //////////////////  Assignment API //////////////////////
  Future<Null> assignmentList() async {
                ...
                child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        right: 20.0,
                        child: AppBar(
                          title: Text("Assignments",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
  ...
  onEdit(index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => NoticeDetails(rowData),
      ),
    );
  }
