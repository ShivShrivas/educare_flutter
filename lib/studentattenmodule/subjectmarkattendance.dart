...
class SubjectAttendanceState extends State<SubjectAttendance> {
 ...
 // List<StudentAttData> studentsdataList = [];
  ...
  Future<Null> classList() async {
    ...
    return await api
      ...
      if(result.isNotEmpty){
        setState(() {
          // result.add(ClassDataList(className: "Select Class",classCode: "0"));
           classlist=result;
  ...
  Future<Null> getStudentList() async {
    ...
    final api = Provider.of<ApiService>(context,listen: false);
    return await api
        .getStudentListSubject("4",relationshipId,sessionId,_classCode,_sectionCode,_subjectCode,fyID,currentDate,saveuseId,saveuseId)
        .then((result) {
      //print(result.length);
      setState(() {
        isLoader = false;
      ...
      //  print("RESULT"+result.toString());
        ...
        if(result.isNotEmpty){
         if(result.toString()=='"1"'){
           ...
           commonAlert.messageAlertError(context,"Attendance already marked for selected date","Already Marked");
         }else{
                ...
                child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        right: 20.0,
                        child: AppBar(
                          title: Text("Subject wise Attendance",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
                                           ...
                                           new Container(
                                             ...
                                             child: GestureDetector(
                                                 ...
                                                 child: new Container(
                                                   ...
                                                   // padding: const EdgeInsets.all(5.0),
                                                   child: Text(currentDate,textAlign: TextAlign.start,style: new TextStyle(color: colors.black,fontSize: 11.0,fontFamily: 'Montserrat',
                                                       fontWeight: FontWeight.w700)),
                                                 )
                                             ),
                                             ...
                                             child: DropdownButton<SubjectData>(
                                               ...
                                               items: this.subjectlist.map((SubjectData data) {
                                                 return DropdownMenuItem<SubjectData>(
                                                   child: Text("  "+data.subjectName,style: new TextStyle(fontSize: 9.0,
                                                       fontFamily: 'Montserrat',
                                                       fontWeight: FontWeight.w700)),
                                                   value: data,
                                                 );
  ...
  Widget _buildRow(BuildContext context, int index) {
    return Card(
     ...
     /* --Static Ip-Address & Server-
          ...
          Vendor Registration
          Tentant Registration
          Tentant Post Complain
          Price Master
          Create / Update all type Bills
          Contract Management
          SMS alert to Vendors
