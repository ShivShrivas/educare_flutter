...
import 'package:educareadmin/homework/createhomework.dart';
                ...
                child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        right: 20.0,
                        child: AppBar(
                          title: Text("Home Work",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
