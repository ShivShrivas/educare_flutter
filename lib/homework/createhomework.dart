...
class CreateHomeWorkState extends State<CreateHomeWork> {
  ...
  List<String> _homeFor = ["All Subject", "Subject wise"];
  String _statusGroupValue = "All",groupType="1";
  String _noticeForGroupValue = "",noticeForType="1";
  ...
  Future<void> getSFData() async{
    ...
    leaveForlist.add(new LeaveFor(name: "",fullName: "---Select Group---"));
  ...
  void _addVideo() async{
    ...
    if(result != null) {
      setState(() {
        selectedFile = File(result.files.single.path!);
        print("FileNameNEW------" + selectedFile.path);
        _fileName = selectedFile.path
            .split("/")
            .last;
        _filePath = selectedFile.path;
        print("VIDEO--FileNameNEW------" + selectedFile.path
            .split("/")
            .last);
      });
    }
  ...
  Future<Null> classList() async {
    ...
    return await api
        .getClassListdiscussion("6",relationshipid,sessionid,userID,fyID)
        .then((result) {
  ...
  Future<Null> sectionList() async {
    ...
    final api = Provider.of<ApiService>(context, listen: false);
    return await api
        .getSectionListdiscussion("6",relationshipid,sessionid,userID,fyID,_classCode)
        .then((result) {
      if(result.isNotEmpty){
        setState(() {
  ...
  Future<Null> subjectList() async {
    ...
    final api = Provider.of<ApiService>(context, listen: false);
    return await api
        .getSubjectList("7",relationshipid,sessionid,userID,fyID,_classCode,_sectionCode)
        .then((result) {
      if(result.isNotEmpty){
        setState(() {
          if(result[0].code != null){
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                        children: [
                          FlatButton(
                            child: new Text("Video (mp3,wav)",style: TextStyle(fontSize: 16.0,fontFamily: 'Montserrat',
                                   fontWeight: FontWeight.w700,color: colors.black)),
                            onPressed: () {
                              Navigator.pop(context);
                              _addVideo();
  ...
  Future<void> saveHomeWork(BuildContext context,int relationshipId,int sessionID,int fyID,int userID) async {
    final api = Provider.of<ApiService>(context, listen: false);
    return await api.createHomeWork(_classCode,_sectionCode,_subjectCode,showdateServer,hidedateServer,topicController.text,descController.text,relationshipId,fyID,sessionID,userID,"1","1")
        .then((result) {
      if(result.isNotEmpty){
        Navigator.of(context,rootNavigator: true).pop();
        if(result.toString() == '"1"'){
          commonAlert.messageAlertSuccess(context,"Home work submitted successfully","Successfully");
        }else{
          commonAlert.messageAlertError(context,"Home work not submitted,Try again","Error");
        }
      }
    }).catchError((error) {
       print("Exception");
       print(error);
       Navigator.of(context,rootNavigator: true).pop();
       commonAlert.messageAlertError(context,"Home work not uploaded","Error");
    });
  }


  int convertRomantoNumber(String roman){
    int num=0;
    if(roman=='X'){
      return 10;
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Create Home Work",textAlign: TextAlign.center,style: new TextStyle(color: Colors.white,fontSize: 16.0,fontFamily: 'Montserrat',
                                  ...
                                  //color: Colors.redAccent,
                                    child: Column(
                                        ...
                                        children: <Widget>[
                                                                              ...
                                                                              child: DropdownButton<ClassDataList>(
                                                                                 ...
                                                                                 onChanged: (ClassDataList? data) {
                                                                                  setState(() {
                                                                                    ...
                                                                                    if(convertRomantoNumber(selectedClassCode!.className)>9){
                                                                                      groupVisible=true;
                                                                                    }else{
                                                                                      groupVisible=false;
                                                                                    }
                                                  ...
                                                  child:Container(
                                                    ...
                                                    child: RadioGroup<String>.builder(
                                                      ...
                                                      onChanged: (value) => setState(() {
                                                        ...
                                                        if(_noticeForGroupValue =="All Subject"){
                                                          noticeForType="1";
                                                        }else{
                                                          noticeForType="2";
                                                        }
                                          ...
                                          ////////////////////////// ------ Select Subject -----  ///////////////////////////////////////////
                                          Visibility(
                                            visible: noticeForType=="1"?false:true,
                                            child: Container(
                                                child: Padding(padding:  new EdgeInsets.all(5.0),
                                                  child: Column(
                                                    //mainAxisAlignment: MainAxisAlignment.center,
                                                      children:<Widget>[
                                                        Row(
                                                            children: [
                                                              Visibility(
                                                                visible: groupVisible==true ? true: false,
                                                                child: Expanded(
                                                                  child: Column(
                                                                      mainAxisAlignment: MainAxisAlignment.start,
                                                                      children:<Widget>[
                                                     ...
                                                     Row(
                                                        children: [
                                                          Expanded(child: ListTile(
                                                            title: Text("Document",style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                fontWeight: FontWeight.w700)),
                                                            leading: Radio(
                                                              value: 1,
                                                              groupValue: val,
                                                              ...
                                                              activeColor: colors.redtheme,
                                                              toggleable: true,
                                                            ),
                                                          ),),

                                                          Expanded(child:  ListTile(
                                                            title: Text("Video",style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                fontWeight: FontWeight.w700)),
                                                            leading: Radio(
                                                              value: 2,
                                                              groupValue: val,
                                                          ...
                                                          Padding(padding:  new EdgeInsets.all(10.0),
                                                              child:  IconButton(icon: Icon(Icons.attach_file_sharp,color: colors.bluelight), onPressed:() {
                                                                ...
                                                                if(val==1){
                                                                  ...
                                                                  commonAlert.showToast(context,"Select attachment type");
                                                                }
                                                              })
                                                          ),
                                                          ...
                                                          child: Material(
                                                            ...
                                                            child: MaterialButton(
                                                              ...
                                                              onPressed: () async {
                                                                ...
                                                                if(_classCode=="0"){
                                                                  commonAlert.showToast(context,"Select Class");
                                                                }else if(_sectionCode=='0'){
                                                                  commonAlert.showToast(context,"Select Section");
                                                                }else if(_subjectCode=='0'){
                                                                  commonAlert.showToast(context,"Select Subject");
                                                                }else if(topicController.text.isEmpty){
                                                                  commonAlert.showToast(context,"Enter Topic");
                                                                  ...
                                                                  final date2 = new DateTime.utc(int.parse(toyear), int.parse(tomonth),int.parse(today));
                                                                  if(date2.compareTo(date1)>0)
                                                                  {
                                                                    ...
                                                                    setState(() {
                                                                      ...
                                                                      //print("API DATA");
                                                                      saveHomeWork(context,relationshipID,sessionid,fyid,userid);
                                                                    });
                                                                    //peform logic here.....
                                                                  }else{
                                                                    commonAlert.showToast(context,"Hide Date should greater and equal to show Date");
                                                                  }
