...
import 'circulardetailsparents.dart';


class CircularsParent extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CircularsParentState();
  }
}


class CircularsParentState extends State<CircularsParent> {
  ...
  onEdit(index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => CircularDetailsParent(rowData),
      ),
    );
  }
