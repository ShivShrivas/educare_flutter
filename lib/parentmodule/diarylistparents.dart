...
import 'diarydetailsparents.dart';

class DiaryParents extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return DiaryParentsState();
  }
}



class DiaryParentsState extends State<DiaryParents> {
  ...
  onEdit(index) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => DiaryDetailsParents(rowData),
      ),
    );
  }
                ...
                child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        right: 20.0,
                        child: AppBar(
                          title: Text("Diary",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
