...
class ComplainState extends State<Complain> {
  ...
  Future<Null> getComplainList() async {
    ...
    return await api
        .getComplains("4",relationshipId,sessionId,saveuseId)
        .then((result) {
      //print(result.length);
      setState(() {
        isLoader = false;
                ...
                child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        ...
                        right: 20.0,
                        child: AppBar(
                          title: Text("Complain Box",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
  ...
  onEdit(index) async {
    ...
    if(complainlist[index].status == 'In-Process'){

      final result = await Navigator.push(
        context, MaterialPageRoute(builder: (context) => ComplainChatBox(rowData)),
      );
      this.getSavedData();
      print("BACKRESULT-- "+ result);
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (BuildContext context) => ComplainChatBox(rowData),
        ),
      );*/
    }
          ...
          children: <Widget>[
            Container(
                ...
                child: new Center(
                  child: RichText(
                    text: TextSpan(
                      text: complainlist[index].complainTo!= null ? complainlist[index].complainTo.toUpperCase(): '',
                                ...
                                RichText(
                                  ...
                                  text: TextSpan(
                                    ...
                                    style: new TextStyle(color: colors.black,fontSize: 12.0,fontFamily: 'Montserrat',
                                        fontWeight: FontWeight.w700),
                                    children: <TextSpan>[
                                      TextSpan(text: complainlist[index].receivedByName != null
                                          ? complainlist[index].receivedByName
