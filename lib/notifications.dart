...
class NotificationsState extends State<Notifications> {
  ...
  List<Notificationdata> datalist = <Notificationdata>[];
  bool isLoader = false;
                    ...
                    child: Stack(
                        children: <Widget>[
                          ...
                          Positioned(
                            ...
                            right: 20.0,
                            child: AppBar(
                              title: Text("Notification",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
       ...
       // onTap: () => onEdit(index),
        child: Padding(
          ...
          child:Column(
            ...
            children: <Widget>[
              Text(datalist[index].title! == null?"":datalist[index].title!,
                  textAlign: TextAlign.start,
                  style: new TextStyle(color: colors.black,fontSize: 13.0,fontFamily: 'Montserrat',
                      fontWeight: FontWeight.w700)),
              SizedBox(height: 5.0),
              Text(datalist[index].notificationBody! == null?"":datalist[index].notificationBody!,
              ...
              Row(
                ...
                children: [
                  Text(datalist[index].notificationDate! == null?"":datalist[index].notificationDate!,
