...
class TimeTableClassSection extends StatefulWidget {


  TimeTableClassSection(this.leaveData) : super();

  final ClassSectionData leaveData;

  @override
  State<StatefulWidget> createState() {
    return TimeTableClassSectionState();
  }
}

class TimeTableClassSectionState extends State<TimeTableClassSection> {
  ...
  Future<Null> getTimetableList() async {
    ...
    return await api
        .timetableClassWiseList(widget.leaveData.classCode,widget.leaveData.code,relationshipId,sessionId)
        .then((result) {
      //print(result.length);
      setState(() {
        isLoader = false;
             ...
             Row(
               ...
               children: [
                 Text(e.dayClass != ''
                     ...
                     : '',
                     style:  TextStyle(color: e.subjectName != '' ?  Colors.white: Colors.black,fontFamily: 'Montserrat',
                         fontWeight: FontWeight.w600,fontSize: 9.0),textAlign: TextAlign.center),
         ...
         child: Column(
           ...
           children: [
             Text(e.periodName != null
                 ? e.periodName
                 : '', style:  TextStyle(color: e.subjectName != ''? Colors.white : Colors.black,fontFamily: 'Montserrat',
                     fontWeight: FontWeight.w600,fontSize: 10.0),textAlign: TextAlign.left),

             SizedBox(height: 5.0),
             Text(e.fromTime != null
                 ? e.fromTime
                 : '', style:  TextStyle(color: e.subjectName != ''? Colors.white :  Colors.black,fontFamily: 'Montserrat',
                     fontWeight: FontWeight.w600,fontSize: 9.0),textAlign: TextAlign.left),
             ],),
          ),
      ))
      .toList();
                                    ...
                                    children: [
                                      Text(dayList[index].periodName != null
                                          ...
                                          style:  TextStyle(color: dayList[index].subjectName != ''? Colors.white :  Colors.black,fontFamily: 'Montserrat',
                                              fontWeight: FontWeight.w600,fontSize: 12.0),textAlign: TextAlign.left),
                                      SizedBox(height: 5.0),
                                      Text(dayList[index].fromTime != null
                      ...
                      child: Padding(padding:  new EdgeInsets.all(1.0),
                        child:   AnimatedContainer(
                          ...
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Text(dayList[index].employeeName != ''
                                  ? dayList [index].employeeName
                                  : '',
                                  style:  TextStyle(color: dayList[index].subjectName != '' ?  Colors.white: Colors.black,fontFamily: 'Montserrat',
                               ...
                               mainAxisAlignment: MainAxisAlignment.center,
                                children: [
                                  Text(dayList[index].dayClass != ''
                                      ...
                                      : '',
                                      style:  TextStyle(color: dayList[index].subjectName != '' ?  Colors.white: Colors.black,fontFamily: 'Montserrat',
                                          fontWeight: FontWeight.w600,fontSize: 10.0),textAlign: TextAlign.center),
