...
class NoticeDetailsApprove extends StatefulWidget {


  NoticeDetailsApprove(this.noticeData) : super();
  ...
  State<StatefulWidget> createState() {
    return NoticeDetailsApproveState();
  }
}


class NoticeDetailsApproveState extends State<NoticeDetailsApprove> {
  ...
  void initState() {
    ...
    headlineController.text= widget.noticeData.noticeHeadline != null
        ? widget.noticeData.noticeHeadline
        : '';
    descriptionController.text=widget.noticeData.description != null
    ...
    ////////////// Approve Dialog //////
    Future<Future<ConfirmAction?>> _accountDeleteDialog(BuildContext context, String message) async {
        ...
        child: Container(
         ...
         child: Stack(
          ...
          Positioned(
            ...
            right: 20.0,
            child: AppBar(
              title: Text("Notice Details",textAlign: TextAlign.center,style: new TextStyle(color: Colors.black,fontSize: 16.0,fontFamily: 'Montserrat',
                              ...
                              child:Container(
                                  ...
                                  child: new GestureDetector(
                                    ...
                                    child: Text("Edit",textAlign: TextAlign.end,
                                        style: new TextStyle(color: colors.bluelight,fontSize: 14.0,fontFamily: 'Montserrat',
                                            fontWeight: FontWeight.w700)),
                                  )
                              )
                          ),
                        ...
                        child: Column(
                            ...
                            children: <Widget>[
                              Text("Title",
                                  ...
                                  style: new TextStyle(fontSize: 14.0,fontFamily: 'Montserrat',
                                      fontWeight: FontWeight.w700)),
                              Row(
                                children: <Widget>[
                                 Expanded(
                                    child: new Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color:isEdit==false?colors.greylight:colors.white ,
                                        ...
                                        child:Container(
                                            ...
                                            child:Center(
                                              child: new GestureDetector(
                                                onTap: () {
                                                  setState(() {
                                                    _accountDeleteDialog(context,"Do you really want to reject?");
                                                  });
                                                },
                                      ...
                                      child:Container(
                                            ...
                                            child: Center(
                                              child:  new GestureDetector(
                                                onTap: () {
                                                  setState(() {
                                                    _accountDeleteDialog(context,"Do you really want to approve?");
                                                  });
                                                },
