          ...
          children: [
            ...
            Visibility(
              ...
              child:FloatingActionButton.extended(
                onPressed: () {
                  Navigator.push(
                      context, MaterialPageRoute(builder: (context) => NoticesApprovals()));
                },
                label: const Text('Notice for Approvals',style: TextStyle(fontSize: 12.0,fontFamily: 'Montserrat',
