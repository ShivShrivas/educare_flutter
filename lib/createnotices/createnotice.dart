...
class CreateNoticeState extends State<CreateNotice> {
  ...
  String _noticeForGroupValue = "",noticeForType="3";
  ...
  ClassSectionData? selectedClassCode;
  String classCode="0";

  List<ClassSectionData?> _selectedClasses = [];
  ...
  void _openFileExplorer() async {
    ...
    setState(() {
      ...
      print("FilePath------" + File(_filePath).path);
    ...
    return await api
      ...
      if(result.isNotEmpty){
        setState(() {
          ...
          classCode = result[0].classCode.toString();
        });
    ...
    return await api
      ...
      if(result.isNotEmpty){
        setState(() {
          ...
          userCode = result[0].roleId.toString();
          print("OutputrelationshipId2 "+ result[0].roleId.toString());
        });
  ...
  Future uploadfile(String tranId,int relationshipID,int sessionid) async{
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.of(context,rootNavigator: true).pop();
      commonAlert.messageAlertError(context,"File Uploading Failed","Error");
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    Row(
                      children: [
                        new Text("Select file type",style: TextStyle(fontSize: 15.0,fontFamily: 'Montserrat',
  ...
  Future<void> saveNoticeData(BuildContext context,int relationshipId,int sessionID,int fyID,int userID) async {
    final api = Provider.of<ApiService>(context, listen: false);
    SharedPreferences preferences = await SharedPreferences.getInstance();
    print("STOREDATA---- $relationshipId " "$sessionID " "$fyID " "$userID");
    return await api.createNotice("1",sendusertypeId,groupType,noticeForType,"",classCode,headlineController.text,descriptionController.text,showdateServer,hidedateServer,relationshipId,sessionID,fyID,userID)
        .then((result) {
         if(result.isNotEmpty){
           if(result[0].status == "1"){
             ...
             commonAlert.messageAlertError(context,"Notice not uploaded","Error");
           }
         }else{
           Navigator.of(context,rootNavigator: true).pop();
  ...
  Widget build(BuildContext context) {
    ...
    final noticeheadline = TextField(
      inputFormatters: [
        LengthLimitingTextInputFormatter(100),FilteringTextInputFormatter.deny(
          RegExp(emojiRegexp),
        )
      ],
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Create Notice",textAlign: TextAlign.center,style: new TextStyle(color: Colors.white,fontSize: 16.0,fontFamily: 'Montserrat',
                                   ...
                                   //color: Colors.redAccent,
                                     child: Column(
                                         ...
                                         children: <Widget>[
                                                             ...
                                                             Expanded(
                                                                 child:Container(
                                                                   child: RadioGroup<String>.builder(
                                                                     ...
                                                                     groupValue: _statusGroupValue,
                                                                     onChanged: (value) => setState(() {
                                                                       _statusGroupValue = value!;
                                                                       if(_statusGroupValue =="All"){
                                                                         groupType="1";
                                                                       }else if(_statusGroupValue =="Staff"){
                                                                         groupType="3";
                                                                       }else if(_statusGroupValue =="Students"){
                                                                         groupType="2";
                                                                       }
                                                                       print(groupType);
                                                                     }),
                                           ...
                                           ////////////////////////// Notice For ///////////////////////////////////////////
                                           Visibility(
                                             visible: _statusGroupValue == 'Students' ? true : false,
                                             child: Container(
                                             child: Card(
                                                 clipBehavior: Clip.antiAlias,
                                                 semanticContainer: true,
                                                         ...
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Notice For",textAlign: TextAlign.left,
                                                           ...
                                                           children: <Widget>[
                                                             Expanded(
                                                                 child:Container(
                                                                   child: RadioGroup<String>.builder(
                                                                     direction: Axis.horizontal,
                                                                     groupValue: _noticeForGroupValue,
                                                                     onChanged: (value) => setState(() {
                                                                       _noticeForGroupValue = value!;
                                                                       print("NoticeFor"+_noticeForGroupValue);
                                                                       if(_noticeForGroupValue =="Class Wise"){
                                                                         noticeForType="1";
                                                                       }else{
                                                                         noticeForType="2";
                                                                       }
                                                                      // print("NoticeFor"+noticeForType);
                                                                     }),
                                                                     items: _noticeFor,
                                                                     itemBuilder: (item) => RadioButtonBuilder(
                                                                       item,
                                           ...
                                           ////////////////////////// Notice For staff ///////////////////////////////////////////
                                           Visibility(
                                             visible: _statusGroupValue == 'Staff' ? true : false,
                                             child: Container(
                                               child: Card(
                                                   clipBehavior: Clip.antiAlias,
                                                   semanticContainer: true,
                                                   ...
                                                   elevation: 5,
                                                   margin: EdgeInsets.all(10),
                                                   child: Padding(padding:  new EdgeInsets.all(3.0),
                                                     child: Column(
                                                       //mainAxisAlignment: MainAxisAlignment.center,
                                                         children:<Widget>[
                                                           Row(
                                                             ...
                                                             children: <Widget>[
                                                               Expanded(
                                                                   child:Container(
                                                                     child: RadioGroup<String>.builder(
                                                                       direction: Axis.horizontal,
                                                                       groupValue: _noticeForStaffValue,
                                                                       onChanged: (value) => setState(() {
                                                                         _noticeForStaffValue = value!;
                                                                         if(_noticeForStaffValue =="Both"){
                                                                           noticeForType="3";
                                                                         }else if(_noticeForStaffValue =="Teaching"){
                                                                           noticeForType="4";
                                                                         }else{
                                                                           noticeForType="5";
                                                                         }
                                                                       }),
                                                                       items: _noticeForStaff,
                                                                       itemBuilder: (item) => RadioButtonBuilder(
                                                                         item,
                                                                       ),
                                                                     ),
                                           ...
                                           Visibility(
                                             visible: _statusGroupValue == 'Students' ? true : false,
                                             child:Visibility(
                                               visible: _noticeForGroupValue == 'Class Wise' ? true : false,
                                               child: Container(
                                                     child: Padding(padding:  new EdgeInsets.all(5.0),
                                                       child: Column(
                                                         //mainAxisAlignment: MainAxisAlignment.center,
                                                           children:<Widget>[
                                                             Row(
                                                               children: [
                                                                 Padding(padding:  new EdgeInsets.all(5.0),
                                                                   child: Text("Select Class",textAlign: TextAlign.left,
                                                                       style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                           fontWeight: FontWeight.w700)),
                                                                 ),
                                                               ],
                                                                 ...
                                                                 Expanded(
                                                                     child: new Container(
                                                                      // height: 50.0,
                                                                       ...
                                                                       child: MultiSelectDialogField<ClassSectionData?>(
                                                                         items: this.classlist
                                                                             .map((classData) => MultiSelectItem<ClassSectionData?>(classData, "${classData.className!}  ${classData.sectionName!}"))
                                                                             .toList(),
                                                                         title: Text("Classes"),
                                                                         ...
                                                                         onConfirm: (results) {
                                                                           ...
                                                                           print(jsonEncode(_selectedClasses));
                                                                       ...
                                                                       /*DropdownButton<ClassSectionData>(
                                                                         isExpanded: true,
                                                                      ...
                                                                      color: Colors.deepPurpleAccent,
                                                                         ...
                                                                         onChanged: (ClassSectionData? data) {
                                                                           setState(() {
                                                                             selectedClassCode = data!;
                                                                             classCode=selectedClassCode!.classCode!;
                                                                            // print(selectedClassCode!.classCode);
                                                                           });
                                                                         },
                                                                         items: this.classlist.map((ClassSectionData data) {
                                                                           return DropdownMenuItem<ClassSectionData>(
                                                                             child: Text("${data.className!}  ${data.sectionName!}",style: new TextStyle(fontSize: 14.0,
                                                                                 fontFamily: 'Montserrat',
                                                                                 fontWeight: FontWeight.w700)),
                                                                             value: data,
                                                                           );
                                           ...
                                           Visibility(
                                             visible: _statusGroupValue == 'Students' ? true : false,
                                               child:Visibility(
                                                 visible: _noticeForGroupValue == 'Class Wise' ? false : true,
                                                 child: Container(
                                                       child: Padding(padding:  new EdgeInsets.all(5.0),
                                                         child: Column(
                                                           //mainAxisAlignment: MainAxisAlignment.center,
                                                                 ...
                                                                 children: <Widget>[
                                                                   Expanded(
                                                                       child: new Container(
                                                                         ...
                                                                         child: Text("Search from list",textAlign: TextAlign.start,style: new TextStyle(color: colors.grey,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                             fontWeight: FontWeight.w700)),
                                                                       )
                                                                   ),
                                                                 ],
                                                                   ...
                                                                   Padding(padding:  new EdgeInsets.all(5.0),
                                                                     child: RichText(
                                                                       ...
                                                                       text: TextSpan(
                                                                         ...
                                                                         style: new TextStyle(color: colors.black,fontSize: 13.0,fontFamily: 'Montserrat',
                                                                             fontWeight: FontWeight.w700),
                                                                         children: <TextSpan>[
                                                                           TextSpan(text: '0', style: TextStyle(color: colors.redtheme,fontSize: 13.0,fontFamily: 'Montserrat',
                                                                               fontWeight: FontWeight.w700)),
                                                                         ],
                                                                       ),
                                                                     ),
                                                     ...
                                                     //mainAxisAlignment: MainAxisAlignment.center,
                                                       children:<Widget>[
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Notice By",textAlign: TextAlign.left,
                                                                   style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                       fontWeight: FontWeight.w700)),
                                                             ),
                                                           ],
                                                                   ...
                                                                   child: DropdownButton<UserType>(
                                                                     ...
                                                                     items: this.userlist.map((UserType data) {
                                                                       return DropdownMenuItem<UserType>(
                                                                         child: Text(data.roleName,style: new TextStyle(fontSize: 14.0,
                                                                             fontFamily: 'Montserrat',
                                                                             fontWeight: FontWeight.w700)),
                                                                         value: data,
                                                                       );
                                                      ...
                                                      Expanded(
                                                        ...
                                                        Expanded(
                                                              ...
                                                              children:<Widget>[
                                                                ...
                                                                GestureDetector(
                                                                    ...
                                                                    child: new Container(
                                                                      ...
                                                                      child: Text(maxdate,textAlign: TextAlign.start,style: new TextStyle(color: colors.grey,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                          fontWeight: FontWeight.w700)),
                                                                    )
                                                                ),
                                                         ...
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Notice Headline",textAlign: TextAlign.left,
                                                                   style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                       fontWeight: FontWeight.w700)),
                                                             ),
                                                           ],
                                                               ...
                                                               child: MaterialButton(
                                                                 ...
                                                                 onPressed: () async {
                                                                   if(headlineController.text.isEmpty){
                                                                     commonAlert.showToast(context,"Enter headline");
                                                                   }else if(descriptionController.text.isEmpty){
                                                                     commonAlert.showToast(context,"Enter description");
                                                                   }else{
                                                                     ...
                                                                     setState(() {
                                                                       ...
                                                                       print("API DATA");
                                                                       saveNoticeData(context,relationshipID,sessionid,fyid,userid);
