...
class CreateCircular extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return CreateCircularState();
  }
}



class CreateCircularState extends State<CreateCircular> {
  ...
  Future<Null> classList() async {
    ...
    return await api
        .getClassList("4",relationshipid,sessionid)
        .then((result) {
      if(result.isNotEmpty){
        setState(() {
          classlist=result;
          selectedClassCode = result[0];
          classCode = result[0].code.toString();
  ...
  Future uploadfile(String tranId,int relationshipID,int sessionid) async{
    ...
    var request = http.MultipartRequest('POST', Uri.parse(colors.imageUploadUrl+'DigitalCircularApi/InsertUpdateDeleteDigitalCircularFiles'));
    ...
    if (response.statusCode == 200) {
      ...
      commonAlert.messageAlertSuccess(context,"Circular saved successfully","Successfully");
  ...
  Future<void> saveNoticeData(BuildContext context,int relationshipId,int sessionID,int fyID,int userID) async {
    final api = Provider.of<ApiService>(context, listen: false);
    return await api.createCircular("1",sendusertypeId,groupType,noticeForType,"",classCode,headlineController.text,descriptionController.text,showdateServer,hidedateServer,relationshipId,sessionID,fyID,userID)
        .then((result) {
         if(result.isNotEmpty){
           if(result[0].status == "1"){
             ...
             if(_filePath.isNotEmpty){
               ...
               commonAlert.messageAlertError(context,"Circular not uploaded","Error");
           }
         }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text("Create Circular".toUpperCase(),textAlign: TextAlign.center,style: new TextStyle(color: Colors.white,fontSize: 16.0,fontFamily: 'Montserrat',
                                                         ...
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Circular For",textAlign: TextAlign.left,
                                                                 ...
                                                                 Expanded(
                                                                     child: new Container(
                                                                       ...
                                                                       child: DropdownButton<ClassData>(
                                                                         ...
                                                                         onChanged: (ClassData? data) {
                                                                           setState(() {
                                                                             selectedClassCode = data!;
                                                                             classCode=selectedClassCode!.code;
                                                                            // print(selectedClassCode.code);
                                                                           });
                                                                         },
                                                                         items: this.classlist.map((ClassData data) {
                                                     ...
                                                     //mainAxisAlignment: MainAxisAlignment.center,
                                                       children:<Widget>[
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Circular By",textAlign: TextAlign.left,
                                                                   style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                       fontWeight: FontWeight.w700)),
                                                             ),
                                                           ],
                                                      ...
                                                      Expanded(
                                                        ...
                                                        Expanded(
                                                         ...
                                                         Row(
                                                           children: [
                                                             Padding(padding:  new EdgeInsets.all(5.0),
                                                               child: Text("Circular Headline",textAlign: TextAlign.left,
                                                                   style: new TextStyle(color: colors.black,fontSize: 14.0,fontFamily: 'Montserrat',
                                                                       fontWeight: FontWeight.w700)),
                                                             ),
                                                           ],
